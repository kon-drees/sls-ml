...
def walkaaf_with_ml1_nn(af_graph: nx.DiGraph, flip_model,g = 0.8,  max_flips=2000, max_tries=200):
    args = set(af_graph.nodes)
    features_dict = precompute_features(af_graph)
...
def walkaaf_with_ml2_nn(af_graph: nx.DiGraph, initial_model,g = 0.8,  max_flips=2000, max_tries=200):
    args = set(af_graph.nodes)
    features_dict = precompute_features(af_graph)
...
def walkaaf_with_ml3_nn(af_graph: nx.DiGraph, flip_model, initial_model,g = 0.8,  max_flips=2000, max_tries=200):
    args = set(af_graph.nodes)
    features_dict = precompute_features(af_graph)
